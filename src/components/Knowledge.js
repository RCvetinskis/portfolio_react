      ...
      <div className="experience-container">
        <div className="experience ">
          ...
          <div className="exp">
            ...
            <p>
              Working on multiple projects , learning javascript, react ,node
              and many more fundamentals for becoming developer.
            </p>
          </div>
        </div>
        div
        <div className="experience ">
          ...
          <div className="exp">
            ...
            <p>
              The ins and outs of HTML5, CSS3, and Modern JavaScript. Making
